  ...
  return (
        <div className="hidden md:flex md:w-1/2 xl:w-1/2 min-h-screen bg-purple-600 relative overflow-hidden">
                ...
                <div className="relative flex flex-col items-center justify-center w-full p-8">
                    ...
                    <div
                        className="relative flex items-center justify-center w-84 h-114 bg-white rounded-2xl p-6 shadow-xl">
                    ...
                    <div className="mt-8 text-center text-white">
                        <h2 className="text-3xl font-bold">Join Forms Today</h2>
                        <p className="mt-2 text-purple-200">Start creating amazing forms in minutes</p>
                    </div>
                </div>
            </div>
  )
