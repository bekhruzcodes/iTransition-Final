...
import { Plus, Trash2, GripVertical, Type, Radio, CheckSquare, List } from 'lucide-react';
                                        ...
                                        <div className="space-y-2 ml-6">
                                            {question.options.map((option, optionIndex) => (
                                                <div key={optionIndex} className="flex items-center gap-2">
                                                    <div className="w-4">
                                                        {question.type === 'radio' && <Radio className="w-4 h-4 text-gray-400" />}
                                                        {question.type === 'checkbox' && <CheckSquare className="w-4 h-4 text-gray-400" />}
                                                        {question.type === 'dropdown' && <List className="w-4 h-4 text-gray-400" />}
                                                    </div>
                                                    <input
                                                        type="text"
                                                        value={option.text}
